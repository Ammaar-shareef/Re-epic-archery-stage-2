...
function setup() {
  ...
  playerArrow = new PlayerArrow(width - 940,playerBase.body.position.y - 180,30,10);
  computerArrow = new ComputerArrow(width - 340,computerBase.body.position.y - 180,30,10);
